...
resource "boundary_scope" "global" {
  global_scope = true
  description  = "Local boundary global scope!"
  scope_id     = "global"
}

resource "boundary_scope" "corp" {
   name                     = "Newton Org"
   description              = "DevOps Master Lab"
...
resource "boundary_auth_method" "password" {
  name     = "${boundary_scope.corp.name} Corp Password"
