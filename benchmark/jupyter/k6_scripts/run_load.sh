...
K6_INFLUXDB_USERNAME=admin K6_INFLUXDB_PASSWORD=admin K6_INFLUXDB_INSECURE=true k6 -q run --system-tags status --out $OUTPUT -e LOAD_ENDPOINT=$LOAD_ENDPOINT -e TARGET=$TARGET -e SIMULATION=$SIMULATION $parameter_env $SCRIPTPATH/$TEST.js
